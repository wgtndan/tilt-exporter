...
scanner.onadvertisement = (advertisement) => {
    ...
    logger.info({message: "New Beacon Received", labels:{'tilt-exporter-uuid': beacon.uuid}, beacon});
    ...
    if (typeof tiltbeacon.colour === 'undefined') {
      // Not a Tilt Beacon
      logger.warn({message: "Detected Non-Tilt Beacon", labels:{'tilt-exporter-uuid': beacon.uuid}});
      return;
    } 
    ...
    logger.info({message: "Valid Beacon Processed", labels:{'tilt-exporter-colour': tiltbeacon.colour, 'tilt-exporter-uuid':tiltbeacon.uuid},  tiltbeacon});
